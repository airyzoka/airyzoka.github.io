...
function respondListen() {
  ...
  let sliderHeight = imageWidth/4;
  let sliderBallRadius = sliderHeight/8;
  let gipSliders = gipContainer.append("g")
                              .attr("transform","translate("+(imageWidth/5)+","+(imageHeight-sliderHeight-2.5*MARGINbr.bottom)+")");
...
gipSliders.append("text").attr("x", 0).attr("y", sliderHeight+2.65*sliderBallRadius).attr("font-size",eqnBoxWidth/30+"px").attr("fill","#fff").attr("dominant-baseline","middle").style("text-anchor", "middle").text("X-shift");

gipSliders.append("rect").attr("class", "gipSliders").attr("width", 2).attr("height", sliderHeight).attr("fill","#fff").attr("x", imageWidth/5).attr("y", 0);
gipSliders.append("circle").attr("class", "yShift").attr("cx",imageWidth/5+1).attr("cy",0).attr("r",sliderBallRadius).call(d3.drag().on("start",yShift).on("drag",yShift).on("end",yShift));
gipSliders.append("text").attr("x", imageWidth/5).attr("y", sliderHeight+2.65*sliderBallRadius).attr("font-size",eqnBoxWidth/30+"px").attr("fill","#fff").attr("dominant-baseline","middle").style("text-anchor", "middle").text("Y-shift");

gipSliders.append("rect").attr("class", "gipSliders").attr("width", 2).attr("height", sliderHeight).attr("fill","#fff").attr("x", 2*imageWidth/5).attr("y", 0);
gipSliders.append("circle").attr("class", "quad").attr("cx",2*imageWidth/5+1).attr("cy",0).attr("r",sliderBallRadius).call(d3.drag().on("start",quadShift).on("drag",quadShift).on("end",quadShift));
gipSliders.append("text").attr("x", 2*imageWidth/5).attr("y", sliderHeight+2.65*sliderBallRadius).attr("font-size",eqnBoxWidth/30+"px").attr("fill","#fff").attr("dominant-baseline","middle").style("text-anchor", "middle").text("__²");

gipSliders.append("rect").attr("class", "gipSliders").attr("width", 2).attr("height", sliderHeight).attr("fill","#fff").attr("x", 3*imageWidth/5).attr("y", 0);
gipSliders.append("circle").attr("class", "forth").attr("cx",3*imageWidth/5+1).attr("cy",0).attr("r",sliderBallRadius).call(d3.drag().on("start",forthShift).on("drag",forthShift).on("end",forthShift));
gipSliders.append("text").attr("x", 3*imageWidth/5).attr("y", sliderHeight+2.65*sliderBallRadius).attr("font-size",eqnBoxWidth/30+"px").attr("fill","#fff").attr("dominant-baseline","middle").style("text-anchor", "middle").text("theFourth⁴");
...
function forthShift() {
  ...
  eqNloss.append("text").attr("class","eqnText")
      .attr("font-size",eqnBoxWidth/28+"px")
      .attr("dominant-baseline","middle")
      .style("text-anchor", "middle")
      .attr("fill","#fff")
